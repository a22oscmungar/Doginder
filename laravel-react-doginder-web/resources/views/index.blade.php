...
<section class="container mx-auto px-4" id="home">
    <div class="flex flex-col lg:flex-row">
        <div class="flex justify-center items-center mx-auto pb-4 lg:w-1/2 lg:justify-end ">
        ...
        <div class="flex justify-center lg:w-1/2 ">
            <img src="{{ Vite::asset('resources/images/mobile-profile.png') }}" width="253" height="506" alt="Doginder"
                class="max-w-[506px] max-h-[710px] shrink-0">
            <!-- <img class="relative top-4 right-5 rotate-90" src="{{ Vite::asset('resources/images/dog-mobile.png') }}" width="120" height="120" alt="Doginder"> -->
        </div>
    </div>
</section>
...
<section class="mx-2" id="download">
    <div class="pt-7">
        ...
        <div class="flex justify-center gap-x-4">
            <svg width="200px" height="200px" viewBox="0 -189.93 539.856 539.856" xmlns="http://www.w3.org/2000/svg">
                ...
                <g transform="scale(4.00216 4.0011)">
                    ...
                    <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="-23.235" y1="97.431" x2="-23.235"
                        y2="61.386" gradientTransform="matrix(4.0022 0 0 4.0011 191.95 -349.736)">
            ...
            <svg width="200px" height="200px" viewBox="0 -47.5 135 135" id="Layer_1" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="tenor-gif-embed" data-postid="17943017" data-share-method="host" data-aspect-ratio="1"
            data-width="100%"></div>
